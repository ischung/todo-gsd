...
- [ ] **CAL-01**: 사용자가 월간 달력 뷰를 볼 수 있다 (현재 월 기본 표시, 요일 헤더 포함)
- [ ] **CAL-02**: 사용자가 이전/다음 달로 이동할 수 있다
- [ ] **CAL-03**: 각 날짜 셀에 해당 날짜의 할 일 개수가 표시된다 (0이면 표시 안 함 또는 0)
- [ ] **CAL-04**: 사용자가 오늘 날짜를 시각적으로 구분해 볼 수 있다

### Todo

- [ ] **TODO-01**: 사용자가 날짜를 클릭하면 그 날짜의 할 일 목록을 볼 수 있다
- [ ] **TODO-02**: 사용자가 선택된 날짜에 새로운 할 일을 추가할 수 있다 (텍스트 입력)
- [ ] **TODO-03**: 사용자가 할 일을 완료/미완료로 토글할 수 있다 (체크박스)
- [ ] **TODO-04**: 사용자가 할 일을 삭제할 수 있다

### Persistence

- [ ] **PERSIST-01**: 모든 할 일 데이터가 브라우저 localStorage에 저장되어 새로고침 후에도 유지된다
